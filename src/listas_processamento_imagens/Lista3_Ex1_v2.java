 ...
 * @author Guilherme
 */
public class Lista3_Ex1_v2 {

    public static void main(String args[]) {
        float deslocamento = (Float.parseFloat(JOptionPane.showInputDialog("Brilho adicional (%): "))) / 100;

        ImageIcon img1;
        URL url1 = Lista3_Ex1_v2.class.getResource("../Imagens/yellow.jpg");
...
//        histogramaR2 = deslocaHistograma(histogramaR,deslocamento);
//        histogramaG2 = deslocaHistograma(histogramaG,deslocamento);
//        histogramaB2 = deslocaHistograma(histogramaB,deslocamento);
