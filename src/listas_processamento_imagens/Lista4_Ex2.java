...
public class Lista4_Ex2 {
    ...
    public static void main(String args[]) {
        ...
        float percentage = Float.parseFloat(JOptionPane.showInputDialog("Algebra do blend (% da imagem 1 sobre a 2) "))/100;
        URL url1 = Lista4_Ex2.class.getResource("../Imagens/coala.jpg");
        img1 = new ImageIcon(url1);

        url1 = Lista4_Ex2.class.getResource("../Imagens/skylin.jpg");
        ...
        for (int j = 0; j < altura; j++) {
            ...
            for (int i = 0; i < largura; i++) {
                ...
                switch (aux) {
                    ...
                    //}
                    case 3:
                        r = (int) ((r * percentage) + (r2 * (1 - percentage)));
                        g = (int) ((g * percentage) + (g2 * (1 - percentage)));
                        b = (int) ((b * percentage) + (b2 * (1 - percentage)));
                        alterada.setRGB(i, j, new Color(r, g, b).getRGB());
                        break;
                    default:
                        break;
